...
def weighted_pinball_loss(y, p50, p70, beta_active=2.0, beta_tail_q=0.30):
    """Active/tail-aware p50+p70 pinball loss.
    ...
    l50 = pinball_elementwise(y, p50, 0.5)
    l70 = pinball_elementwise(y, p70, 0.7)
...
def train(
    ...
    for epoch in range(epochs):
        ...
        for bi, b in enumerate(tr_ld):
            ...
            # v12: keep original NB NLL, but make quantile calibration active/tail-aware.
